...
| Perspective | **2D top-down** | Matches the art direction (illustrated storybook, top-down). 2D is dramatically simpler to build, author content for, and generate AI art for than 3D. |
...
| Art | **AI-generated assets**, imported as PNGs with transparent backgrounds | Consistent prompt templates per asset category keep the style coherent. Placeholder colored shapes are used until art exists — gameplay never waits on art. |
